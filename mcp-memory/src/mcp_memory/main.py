...
def build_tools() -> MemoryTools:
    ...
    return MemoryTools(settings, repository, SearchService(repository, qdrant_store, score_threshold=settings.search_score_threshold), outbox_max_workers=settings.outbox_max_workers)
